...
function [x,y] = GVFSnake(I,px,py,x0,y0, alpha,beta,gamma,kappa,nbiter,stepIter,maxChange, fid)
...
while i<nbiter && ~stop
    ...
    N =length(x);
    invAI = snakeDeformMatrix(N, alpha,beta,gamma);
